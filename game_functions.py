...
def ship_hit(ai_settings, stats, sb, screen, ship, aliens, bullets) -> None:
...
def check_aliens_bottom(ai_settings, stats, sb, screen, ship, aliens, bullets) -> None:
...
def update_aliens(ai_settings, stats, sb, screen, ship, aliens, bullets) -> None:
    """
...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets) -> None:
